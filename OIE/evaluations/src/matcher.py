...
from OIE.evaluations.src.benchmark import Benchmark
...
class Matcher:
    ...
    @staticmethod
    def identicalMatch(ref, ex, ignoreStopwords=True, ignoreCase=True):
        arg1_ref = Benchmark.normalizeKey(ref["arg1"])
        rel_ref = Benchmark.normalizeKey(ref["rel"])
        arg2_ref = Benchmark.normalizeKey(ref["arg2"])
    ...
    BLEU_THRESHOLD = 0.4
    LEXICAL_THRESHOLD = (
        0.5  # Note: changing this value didn't change the ordering of the tested systems
    )
